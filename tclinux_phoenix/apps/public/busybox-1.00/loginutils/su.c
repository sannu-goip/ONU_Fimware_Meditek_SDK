...
int su_main ( int argc, char **argv )
{
	...
	{
		/* default for telecomadmin */
		bzero(telecom_account, sizeof(telecom_account));
		if ( 0 == tcapi_get("Account_TelnetEntry", "telnet_admin_username", telecom_account)
			&& 0 != telecom_account[0] )
			opt_username = telecom_account;
	}
#endif
