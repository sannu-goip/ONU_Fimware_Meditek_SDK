...
#endif
	tcapi_set("System_Entry", "upgrade_status", "");      
...
static int create_server_socket(void)
{
	...
	if ( -1 == setsockopt(server_s, SOL_SOCKET, SO_BINDTODEVICE, "br0", sizeof("br0")) )
	{
		printf("[ReBindToDevice]: bind fail,socket=%d\n", server_s);
	}
#endif
