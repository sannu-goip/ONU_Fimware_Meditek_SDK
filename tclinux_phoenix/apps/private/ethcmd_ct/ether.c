...
macRT63365VlanSetVid(u8 index, u8 active, u16 vid, u8 portMap, u8 tagPortMap, u8 ivl_en, u8 fid, u16 stag){
#else
...
*/
int 
macRT63365VlanGetVtbl(u8 index){
	u16 vid=0;
