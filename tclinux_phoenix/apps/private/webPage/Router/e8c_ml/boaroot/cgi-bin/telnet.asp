...
function setSsh()
{
	...
	{
		if (enablessh.checked == true)
			sshenable_flag.value = "Yes";
		else
			sshenable_flag.value = "No";
	}
}
</script>
</HEAD>
          ...
          <TD>
            <FORM id="ConfigForm" name="ConfigForm" action="/cgi-bin/telnet.asp" method="post">
              ...
              <TR>
                ...
                <TR>
                <TD width=10>&nbsp;</TD>
                <TD>SSH: Enable<INPUT id="enablessh" onclick="setSsh()" type="checkbox" name="enablessh" checked>
				</TD>
        <TD width=10>&nbsp;</TD></TR>
