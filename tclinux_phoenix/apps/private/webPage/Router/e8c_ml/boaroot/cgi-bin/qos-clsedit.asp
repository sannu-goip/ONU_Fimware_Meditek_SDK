...
<td width="50" valign="bottom"><a href="/cgi-bin/login.asp" target="_top" onClick="DoLogout()">
<span class="logout">
...
<input name="Selected_Menu" type="hidden" id="Selected_Menu" value="<%tcWebApi_get("String_Entry","ContentNetText","s")%>-><%tcWebApi_get("String_Entry","ContentQosText","s")%>">
...
<tr>
<td valign='top'><a href="../cgi-bin/help_content.asp#QoS" target="_blank"><img src="<%tcWebApi_get("String_Entry","IMGHelpText","s")%>" width="40" height="34" border="0"></a></td>
</tr>
...
<td width="7" background="/img/panel3.gif">　</td>
<td>
<form id="ConfigForm" name="ConfigForm" action="/cgi-bin/qos-clsedit.asp" method="post">
...
<td width="92">
	  <input type="hidden" id="Wanvalue" name="Wanvalue" value="<% tcWebApi_get("QoS_Entry","nas0","s") %>">
	  <input type="hidden" id="Lanvalue" name="Lanvalue" value="<% tcWebApi_get("QoS_Entry","eth0","s") %>">
	  <input type="hidden" id="DSCPRangevalue" name="DSCPRangevalue" value="<% tcWebApi_get("QoS_Entry","DSCPRangeEnd","s") %>"> 
	  <input type="hidden" id="Dotpvalue" name="Dotpvalue" value="<% tcWebApi_get("QoS_Entry","dotpEnd","s") %>">
	  <input type="hidden" id="SIPRangevalue" name="SIPRangevalue" value="<% tcWebApi_get("QoS_Entry","SrcIPRangeEnd","s") %>">
	  <input type="hidden" id="DIPRangevalue" name="DIPRangevalue" value="<% tcWebApi_get("QoS_Entry","DesIPRangeEnd","s") %>">
	  <input type="hidden" id="SPORTvalue" name="SPORTvalue" value="<% tcWebApi_get("QoS_Entry","SrcPortRangeEnd","s") %>">
	  <input type="hidden" id="DPORTvalue" name="DPORTvalue" value="<% tcWebApi_get("QoS_Entry","DesPortRangeEnd","s") %>">
	  <input type="hidden" id="TOSvalue" name="TOSvalue" value="<% tcWebApi_get("QoS_Entry","ActToSRemarking","s") %>">
	  <input type="hidden" id="SMACvalue" name="SMACvalue" value="<% tcWebApi_get("QoS_Entry","SrcMac","s") %>">
	  
	  <input type="hidden" id="TypeDelFlag0" name="TypeDelFlag0" value="No">
	  <input type="hidden" id="TypeDelFlag1" name="TypeDelFlag1" value="No">
	  <input type="hidden" id="TypeDelFlag2" name="TypeDelFlag2" value="No">
	  <input type="hidden" id="TypeDelFlag3" name="TypeDelFlag3" value="No">
	  <input type="hidden" id="TypeDelFlag4" name="TypeDelFlag4" value="No">
	  <input type="hidden" id="TypeDelFlag5" name="TypeDelFlag5" value="No">
	  <input type="hidden" id="TypeDelFlag6" name="TypeDelFlag6" value="No">
	  <input type="hidden" id="TypeDelFlag7" name="TypeDelFlag7" value="No">
	  <input type="hidden" id="TypeDelFlag8" name="TypeDelFlag8" value="No">
	  <input type="hidden" id="TypeDelFlag9" name="TypeDelFlag9" value="No">
	  <input type="hidden" id="DelNULLFlag" name="DelNULLFlag" value="N/A">
	  ...
	  <input type="hidden" id="TypeModifyID" name="TypeModifyID" value="-1">	  
...
function QosShowInit()
{
	if (CurQoS == null)
	{
		alert("<%tcWebApi_get("String_Entry","FailGetDataText","s")%>");
	}
	CurQoSShow();
}
...
loc += '<TR align="middle">';
loc += '<TD align="center"><%tcWebApi_get("String_Entry","ServiceNameText","s")%></TD>';
loc += '<TD align="center"><%tcWebApi_get("String_Entry","QueueText","s")%></TD>';
loc+= '<TD align="center"><%tcWebApi_get("String_Entry","ModificationText","s")%></TD></TD>';
loc+= '<TD width=92><INPUT id=DelApp onclick=btnDelApp() type=button value=<%tcWebApi_get("String_Entry","DeleteServiceText","s")%> name=DelApp></TD>'
loc+= '<TD width=92><INPUT id=AddApp onclick=btnAddApp() type=button value=<%tcWebApi_get("String_Entry","AddServiceText","s")%> name=AddApp></TD>'
loc+= '</TR>';
for(k=0; k < AppCnt; k++)
{
	loc += '<TR align="middle">';
...
LanList[4] = new stLan("5","LAN5");
LanList[5] = new stLan("6","LAN6");
LanList[6] = new stLan("7","LAN7");
LanList[7] = new stLan("8","LAN8");
<% if TCWebApi_get("WebCustom_Entry","isWLanSupported","h" ) = "Yes" then %>
LanList[8] = new stLan("9","SSID1");
LanList[9] = new stLan("10","SSID2");
LanList[10] = new stLan("11","SSID3");
LanList[11] = new stLan("12","SSID4");
LanList[12] = new stLan("13","SSID5");
LanList[13] = new stLan("14","SSID6");
LanList[14] = new stLan("15","SSID7");
LanList[15] = new stLan("16","SSID8");
<% if TCWebApi_get("WebCustom_Entry","isWLanACSupported","h" ) = "Yes" then %>
LanList[16] = new stLan("17","SSIDAC1");
LanList[17] = new stLan("18","SSIDAC2");
LanList[18] = new stLan("19","SSIDAC3");
LanList[19] = new stLan("20","SSIDAC4");
LanList[20] = new stLan("21","SSIDAC5");
LanList[21] = new stLan("22","SSIDAC6");
LanList[22] = new stLan("23","SSIDAC7");
LanList[23] = new stLan("24","SSIDAC8");
<% end if %>	
<% end if %>
<% else %>
<% if TCWebApi_get("WebCustom_Entry","isWLanSupported","h" ) = "Yes" then %>
...
<% if TCWebApi_get("WebCustom_Entry","isMultiUserITFSupported","h" ) = "Yes" then %>
LanList[6] = new stLan("9","SSID5");
LanList[7] = new stLan("10","SSID6");
LanList[8] = new stLan("11","SSID7");
LanList[9] = new stLan("12","SSID8");
<% end if %>
<% end if %>
<% if TCWebApi_get("WebCustom_Entry","isWLanACSupported","h" ) = "Yes" then %>
<% if TCWebApi_get("WebCustom_Entry","isMultiUserITFSupported","h" ) <> "Yes" then %>
...
<% else %>
LanList[10] = new stLan("13","SSIDAC1");
LanList[11] = new stLan("14","SSIDAC2");
LanList[12] = new stLan("15","SSIDAC3");
LanList[13] = new stLan("16","SSIDAC4");
LanList[14] = new stLan("17","SSIDAC5");
LanList[15] = new stLan("18","SSIDAC6");
LanList[16] = new stLan("19","SSIDAC7");
LanList[17] = new stLan("20","SSIDAC8");
<% end if %>	
<% end if %>
<% end if %>
...
function writeClsTable()
{
	...
	loc = '<TABLE cellSpacing=0 cellPadding=3 width=465 border=1>';
	loc += '<TR align="middle">';
	loc += '<TD align="center"><%tcWebApi_get("String_Entry","ClassificationText","s")%></TD>';
	loc += '<TD align="center">DSCP/TC<%tcWebApi_get("String_Entry","ValueText","s")%></TD>';
	loc += '<TD align="center">802.1p<%tcWebApi_get("String_Entry","ValueText","s")%></TD>';
	loc += '<TD align="center"><%tcWebApi_get("String_Entry","AddTypeText","s")%></TD>';
	loc += '<TD align="center"><%tcWebApi_get("String_Entry","ModificationText","s")%></TD>';
	loc+= '<TD width=92><INPUT id=Delcls onclick=btnDelCls() type=button value=<%tcWebApi_get("String_Entry","DeleteText","s")%> name=DelCls></TD>'
	loc+= '<TD width=92><INPUT id=AddCls onclick=btnAddCls() type=button value=<%tcWebApi_get("String_Entry","AddServiceText","s")%> name=AddCls></TD>'
	loc += '</TR>';
...
function writeTypeTable(domain)
{
	...
	loc += '<TR align="middle">';
	loc += '<TD align="center"><%tcWebApi_get("String_Entry","ClassificationText","s")%></TD>';
	loc += '<TD align="center"><%tcWebApi_get("String_Entry","MinText","s")%></TD>';
	loc += '<TD align="center"><%tcWebApi_get("String_Entry","MaxText","s")%></TD>';
	loc += '<TD align="center"><%tcWebApi_get("String_Entry","ProtocolText","s")%></TD>';
	loc += '<TD align="center"><%tcWebApi_get("String_Entry","ModificationText","s")%></TD>';
	loc+= '<TD width=92><INPUT id=DelClsType onclick=btnDelClsType() type=button value=<%tcWebApi_get("String_Entry","DeleteTypeText","s")%> name=DelClsType></TD>'
	loc += '</TR>';
	if (CurQoS.Class == null)
	{
		return;
...
loc +='<tr><td width="90"><%tcWebApi_get("String_Entry","InterfaceText","s")%></td>';
loc +='<td colspan="6">';
...
var loc,k;
loc = '<table width="100%" border="0">';
loc +='<tr><td width="90"><%tcWebApi_get("String_Entry","MinText","s")%></td>';
loc +='<td colspan="6">';
...
loc +='</select></td>';
loc +='</tr>';
loc +='<tr><td width="90"><%tcWebApi_get("String_Entry","MaxText","s")%></td>';
loc +='<td colspan="6">';
...
function QoSClsDelSubmit()
{
	...
	with (getElById('ConfigForm'))
	{
		...
		if(DelClsCount==0)
		{
			alert("<%tcWebApi_get("String_Entry","NotSelectText","s")%>");
			return;
		}
		if(!confirm("<%tcWebApi_get("String_Entry","DeleteSelectedText","s")%>"))
		{
			return;
		}
...
function QoSAppDelSubmit()
{
	...
	with (getElById('ConfigForm'))
	{
		...
		if(DelClsCount==0)
		{
			alert("<%tcWebApi_get("String_Entry","NotSelectServiceText","s")%>");
			return;
		}
		if(!confirm("<%tcWebApi_get("String_Entry","DeleteSelectedText","s")%>"))
		{
...
with (getElById('ConfigForm'))
{
	if(AddFlag  == true)
	{
		if(AppCnt >= 5)
		{
			alert("<%tcWebApi_get("String_Entry","OnlyConfigure4Text","s")%>APP");
			setDisplay('Cls',0);
			return false;
		}
	}
	if(getValue('AppName')=='')
	{
		alert("<%tcWebApi_get("String_Entry","ServiceNotEmptyText","s")%>");
		return false;
	}
if(AddFlag  == true)
{
...
{
	alert("<%tcWebApi_get("String_Entry","APPExistedText","s")%>");
	return false;
}
}
}
...
if(getValue('AppName')==CurQoS.App[i].AppName)
{
	alert("<%tcWebApi_get("String_Entry","ConflictsText","s")%>");
return false;
}
}
...
{
	alert("<%tcWebApi_get("String_Entry","NotModificationText","s")%>");
	setDisplay('Cls',0);
return false;
}
}
...
{
alert("<%tcWebApi_get("String_Entry","ValidValue1Text","s")%>");

return false;
}
if (is_integer(v8021p) == false ||  v8021p < 0 || v8021p > 7)
{
	alert("<%tcWebApi_get("String_Entry","ValidValue2Text","s")%>");
	return false;
}
}
return true;
...
function ProtocolCheck()
{
	...
	if ( (('DPORT' == clsType) || ('SPORT' == clsType))
		&& (('ICMP' == protocol)) )
	{
			alert("<%tcWebApi_get("String_Entry","ICMPnotSetPortsText","s")%>");
			return false;
	}
	...
	for (k = 0; k < ClsTypeCnt; k++)
	{
		...
		if (Typedomain.indexOf(domain) >= 0)
		{
			if(CurTypeArray[k].ProtocolList != protocol && CurTypeArray[k].ProtocolList !="N/A" )
			{
					...
					{
						alert("<%tcWebApi_get("String_Entry","ProtocolnotsameText","s")%>");
						return false;
					}
			}
		return true;
...
{
alert("<%tcWebApi_get("String_Entry","NotSameTypeText","s")%>");
return false;
}
if ((CurTypeArray[k].Type == 'TOS' && ClsType == 'DSCP')
|| (CurTypeArray[k].Type == 'DSCP' && ClsType == 'TOS'))
{
alert("<%tcWebApi_get("String_Entry","NotAllowTOSAndDSCPText","s")%>");
return false;
}
}
}
...
if (Classifytype =='SMAC')
{
	...
	{
		alert("<%tcWebApi_get("String_Entry","MinAddressInvalidText","s")%>");
		return false;
	}
	else if (max != '' && isValidMacAddress(max) == false)
	{
		alert("<%tcWebApi_get("String_Entry","MaxAddressInvalidText","s")%>");
		return false;
	}
	else if (min != max)
	{
		alert("<%tcWebApi_get("String_Entry","MinMACSameMAXText","s")%>");
		return false;
}
}
else if (Classifytype =='8021P')
{
	...
	{
		alert("<%tcWebApi_get("String_Entry","EntermaxText","s")%>");
		return false;
	}
	else if (min != '' && (is_integer(min) == false ||  min < 0 || min > 7))
	{
		alert("<%tcWebApi_get("String_Entry","EnterMinText","s")%>");
		return false;
	}
	else if (parseInt(min) > parseInt(max))
	{
		alert("<%tcWebApi_get("String_Entry","MinLargerMaxText","s")%>");
		return false;
	}
}
else if (Classifytype =='SIP')
{
	...
	{
		var TipStr = '<%tcWebApi_get("String_Entry","SourceText","s")%>IP<%tcWebApi_get("String_Entry","AddressMaxText","s")%>"' + max + '" <%tcWebApi_get("String_Entry","IsInvalidText","s")%>';
		alert(TipStr);
		return false;
	}
	else if (min != '' && (isAbcIpAddress(min) == false)	&& (isIpv6Address(min) == false))
	{
		var TipStr = '<%tcWebApi_get("String_Entry","SourceText","s")%>IP<%tcWebApi_get("String_Entry","AddressMinText","s")%>"' + min + '" <%tcWebApi_get("String_Entry","IsInvalidText","s")%>';
		alert(TipStr);
		return false;
	}
	else if ((isAbcIpAddress(min) == true) && (isAbcIpAddress(max) == true)	&& (cmpIpAddress(max ,min) == false))
	{
		var TipStr = '<%tcWebApi_get("String_Entry","SourceText","s")%>IP<%tcWebApi_get("String_Entry","AddressMinText","s")%>"' + min + '" <%tcWebApi_get("String_Entry","LargerMaxText","s")%>'+max;
		alert(TipStr);
		return false;
	}
	else if ((isIpv6Address(min) == true)	 || (isIpv6Address(max) == true) )
	{
		if (max != min)
		{
			alert("<%tcWebApi_get("String_Entry","MinIPv6SameMaxText","s")%>");
			return false;
		}
	}
}
else if (Classifytype =='DIP')
{
	if (max != '' && (isAbcIpAddress(max) == false) && (isIpv6Address(max) == false))
	{
		var TipStr = '<%tcWebApi_get("String_Entry","DestinationText","s")%>IP<%tcWebApi_get("String_Entry","AddressMaxText","s")%>"' + max + '" <%tcWebApi_get("String_Entry","IsInvalidText","s")%>';
		alert(TipStr);
		return false;
	}
	else if (min != '' && (isAbcIpAddress(min) == false) && (isIpv6Address(min) == false))
	{
		var TipStr = '<%tcWebApi_get("String_Entry","DestinationText","s")%>P<%tcWebApi_get("String_Entry","AddressMinText","s")%>"' + min + '" <%tcWebApi_get("String_Entry","IsInvalidText","s")%>';
		alert(TipStr);
		return false;
	}
	else if ((isAbcIpAddress(min) == true) && (isAbcIpAddress(max) == true) && (cmpIpAddress(max ,min) == false))
	{
		var TipStr = '<%tcWebApi_get("String_Entry","DestinationText","s")%>IP<%tcWebApi_get("String_Entry","AddressMinText","s")%>"' + min + '" <%tcWebApi_get("String_Entry","LargerMaxText","s")%>'+max;
		alert(TipStr);
		return false;
	}
	else if ((isIpv6Address(min) == true)	 || (isIpv6Address(max) == true) )
...
else if ((Classifytype =='DPORT')||(Classifytype =='SPORT'))
{
	...
	{
		alert("<%tcWebApi_get("String_Entry","MaxPortInvalidText","s")%>");
		return false;
	}
	else if (min != '' && isValidPort(min) == false)
	{
		alert("<%tcWebApi_get("String_Entry","MinPortInvalidText","s")%>");
		return false;
	}
	else if (parseInt(min) > parseInt(max))
	{
		alert("<%tcWebApi_get("String_Entry","MinPortLargerMaxText","s")%>");
		return false;
	}
}
else if (Classifytype =='DSCP')
{
	...
	{
		alert("DSCP/TC<%tcWebApi_get("String_Entry","MinPortLargerMaxText","s")%>");
		return false;
	}
	else if (min != '' && (is_integer(min) == false ||  min < 0 || min> 63))
	{
		alert("DSCP/TC<%tcWebApi_get("String_Entry","MinShouldText","s")%>");
		return false;
	}
	else if (parseInt(min) > parseInt(max))
	{
		alert("DSCP/TC<%tcWebApi_get("String_Entry","MinLargerMaxText","s")%>");
		return false;
	}
}
...
{
	alert("<%tcWebApi_get("String_Entry","InterfaceMinText","s")%>");
	setDisplay('Cls',0);
	return false;
}
}
...
<div id = 'ClsTable'></div>
<table width="100%" border="0">  <tr>
<td width="92"><input type="hidden" id="QoS_Flag" name="QoS_Flag" value="-1">
                          <input type="hidden" id="Del_Flag" name="Del_Flag" value="0">
                          <input type="hidden" id="curAppIdx" name="curAppIdx" value="<% tcWebApi_get("QoS_Common","curAppIdx","s") %>">
                          <input type="hidden" id="curSubTypeIdx" name="curSubTypeIdx" value="<% tcWebApi_get("QoS_Common","curSubTypeIdx","s") %>">
						  <input type="hidden" id="curTypeIdx" name="curTypeIdx" value="<% tcWebApi_get("QoS_Common","curTypeIdx","s") %>">
                          <input type="hidden" id="App_Flag" name="App_Flag" value="Yes">
                          <input type="hidden" id="DiscplineFlag" name="DiscplineFlag" value="<%if tcWebApi_get("QoS_Common","Discipline","h") <> "N/A" then tcWebApi_get("QoS_Common","Discipline","s") else asp_Write("SP") end if%>">
                          <input type="hidden" id="LanFlag0" name="LanFlag0" value="No">
                          <input type="hidden" id="LanFlag1" name="LanFlag1" value="No">
                          <input type="hidden" id="LanFlag2" name="LanFlag2" value="No">
                          <input type="hidden" id="LanFlag3" name="LanFlag3" value="No">
                          <input type="hidden" id="LanFlag4" name="LanFlag4" value="No">
                          <input type="hidden" id="LanFlag5" name="LanFlag5" value="No">
                          <input type="hidden" id="LanFlag6" name="LanFlag6" value="No">
                          <input type="hidden" id="LanFlag7" name="LanFlag7" value="No">
                          <input type="hidden" id="WanFlag0" name="WanFlag0" value="No">
                          <input type="hidden" id="WanFlag1" name="WanFlag1" value="No">
                          <input type="hidden" id="WanFlag2" name="WanFlag2" value="No">
                          <input type="hidden" id="WanFlag3" name="WanFlag3" value="No">
                          <input type="hidden" id="WanFlag4" name="WanFlag4" value="No">
                          <input type="hidden" id="WanFlag5" name="WanFlag5" value="No">
                          <input type="hidden" id="WanFlag6" name="WanFlag6" value="No">
                          <input type="hidden" id="WanFlag7" name="WanFlag7" value="No"> 
                          <script language="JavaScript" type="text/JavaScript">
						  </script>
                          &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
...
<div id="AppEdit">
<table width="100%" border="0">  <tr>
<td width="92" height="30"><%tcWebApi_get("String_Entry","ServiceNameText","s")%></td>
...
<input type="hidden" id="AppDelNo10" name="AppDelNo10" value="No">
<input type="hidden" id="AppDelNo11" name="AppDelNo11" value="No">
<input type="hidden" id="AppDelNo12" name="AppDelNo12" value="No">
<input type="hidden" id="AppDelNo13" name="AppDelNo13" value="No">
<input type="hidden" id="ClsDelNo0" name="ClsDelNo0" value="No">
<input type="hidden" id="ClsDelNo1" name="ClsDelNo1" value="No">
<input type="hidden" id="ClsDelNo2" name="ClsDelNo2" value="No">
<input type="hidden" id="ClsDelNo3" name="ClsDelNo3" value="No">
<input type="hidden" id="ClsDelNo4" name="ClsDelNo4" value="No">
<input type="hidden" id="ClsDelNo5" name="ClsDelNo5" value="No">
<input type="hidden" id="ClsDelNo6" name="ClsDelNo6" value="No">
<input type="hidden" id="ClsDelNo7" name="ClsDelNo7" value="No">
<input type="hidden" id="ClsDelNo8" name="ClsDelNo8" value="No">
<input type="hidden" id="ClsDelNo9" name="ClsDelNo9" value="No">

</td>
</tr>
</table>
<table id = 'CarQueue' width="100%" border="0">  <tr>
<td width="92"><%tcWebApi_get("String_Entry","ClassificationText","s")%></td>
<td width="381" colspan="6">
...
<% end if %>
                              ...
                              <input type="hidden" id="AppQueueFlag" name="AppQueueFlag" value="1"> </td>
</tr>
</table>
<table width="100%" border="0">
<tr>
<td width="92">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="AddConfirm" type="button" id="AddConfirm" onClick="QoSAppSubmit()" value="<%tcWebApi_get("String_Entry","SubmitText","s")%>"/>      </td>
</tr>
</table>
</div>
<div id="ClsEdit">
...
<% end if %>
                              ...
                              <input type="hidden" id="ClsQueueValueFlag" name="ClsQueueValueFlag" value="1"> </td>
</tr>
</table>
<table width="100%" border="0">  <tr>
<td width="92">DSCP/TC<%tcWebApi_get("String_Entry","ValueText","s")%></td>
<td width="384"><input name="DSCPMarkValue" type="text" id="DSCPMarkValue" value="0" size="10" maxlength="8"> </td>
</tr>
</table>
<table width="100%" border="0">  <tr>
<td width="96">802.1P<%tcWebApi_get("String_Entry","ValueText","s")%></td>
...
<tr>
<td width="92">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="AddConfirm" type="button" id="AddConfirm" onClick="QoSClsSubmit()" value="<%tcWebApi_get("String_Entry","SubmitText","s")%>"/>      </td>
</tr>
</table>
</div>
<div id="ClsTypeEdit">
<table width="100%" border="0">  <tr>
<td width="93"><%tcWebApi_get("String_Entry","ClassificationText","s")%></td>
...
<tr><td width="100"><%tcWebApi_get("String_Entry","MinText","s")%></td>
<TD width=401><INPUT id="Min" maxLength="128" value="" size="40" name="Min"></TD>
</tr>
<tr>
<td width="100"><%tcWebApi_get("String_Entry","MaxText","s")%></td>
<TD width=401><INPUT id="Max" maxLength="128" value="" size="40" name="Max"></TD></tr>
</table>
<table width="104%" border="0">  <tr>
<td width="94"><%tcWebApi_get("String_Entry","ProtocolTypeText","s")%></td>
...
<tr>
<td width="92">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input name="AddConfirm" type="button" id="AddConfirm" onClick="QoSTypeSubmit()" value="<%tcWebApi_get("String_Entry","SubmitText","s")%>"/>      </td>
</tr>
</table>
</div>
</div>
...
<input name="RtturnQoS" type="button" id="RtturnQoS" onClick="btnRtturnQoS()" value="<%tcWebApi_get("String_Entry","BackText","s")%>"/></td>
</tr>
</table>
<SCRIPT language=JavaScript type=text/javascript>
QosShowInit();
...
<p align="center"><img src="<%tcWebApi_get("String_Entry","IMGOKText","s")%>" width="80" height="23" border="0" id="btnOK" onClick="QosSubmit()">&nbsp;
<IMG id=btnCancel height=23 src="<%tcWebApi_get("String_Entry","IMGCancelText","s")%>" onclick="RefreshPage()" width=80 border=0> </td>
