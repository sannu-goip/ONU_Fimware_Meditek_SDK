...
TC_CFLAGS+=-DTCSUPPORT_OPENWRT
endif

TC_CFLAGS+= -I$(INSTALL_GLOBALINC) -I$(INSTALL_GLOBALINC)/uapi -I$(VERSION_APP_DIR)
...
TC_CFLAGS+= -DTCSUPPORT_LITTLE_ENDIAN
endif
...
TC_CFLAGS+=-DTCSUPPORT_SECURE_BOOT
...
export TCSUPPORT_ACTIVE_ETHERNET_WAN
TC_CFLAGS+=-DTCSUPPORT_ACTIVE_ETHERNET_WAN
endif
...
TC_CFLAGS+=-DTCSUPPORT_TEST_WLAN_SHORTCUT
endif
endif
...
TC_CFLAGS+=-DRT5392 -DWLAN_MULTIDRIVER -DTCSUPPORT_WLAN_MULTIDRIVER
...
TC_CFLAGS+=-DTCSUPPORT_RA_HWNAT -DTCSUPPORT_HWNAT_V3
else
TC_CFLAGS+=-DTCSUPPORT_RA_HWNAT 
endif
...
TC_CFLAGS+=-DTCSUPPORT_IPV6_CEROUTER
endif
...
TC_CFLAGS+=-DTCSUPPORT_VOIP_16FXS
endif

ifneq ($(strip $(TCSUPPORT_VOIP_DUAL_SIP)),)
export TCSUPPORT_VOIP_DUAL_SIP
TC_CFLAGS+=-DTCSUPPORT_VOIP_DUAL_SIP
endif
...
TC_CFLAGS+=-DVOIP_MAX_CHAN=$(VOIP_MAX_CHAN)
else
TC_CFLAGS+=-DVOIP_MAX_CHAN=2
endif
ifneq ($(strip $(TCSUPPORT_CT_VOIP_JOYME4)),)
export TCSUPPORT_CT_VOIP_JOYME4=1
TC_CFLAGS+=-DTCSUPPORT_CT_VOIP_JOYME4
endif
endif
...
TC_CFLAGS+=-DTCSUPPORT_CWMP_SSL -DTCSUPPORT_CWMP_OPENSSL -DOPENSSL_NO_CATIME
else
export SSL=1
TC_CFLAGS+=-DSSL -DTCSUPPORT_CWMP_SSL
endif
...
TC_CFLAGS+=-DTCSUPPORT_CWMP_TR181
endif
endif
...
TC_CFLAGS+=-DTCSUPPORT_CLMP_NG
export CLMP_CFLAGS=-DUPNP_ENABLE_ECNT -I$(APP_OPENSSL_DIR_V1)/OPSSL/include
export CLMP_LDFLAGS=-L$(APP_OPENSSL_DIR_V1)/OPSSL/lib -lssl -lcrypto -lpthread
endif

ifneq ($(strip $(TCSUPPORT_CWMP_NG)),)
export TCSUPPORT_CWMP_NG=1
TC_CFLAGS+=-DTCSUPPORT_CWMP_NG
...
TC_CFLAGS+=-DTCSUPPORT_QOS_EIGHT_QUEUE
endif
...
TC_CFLAGS+=-DTCSUPPORT_PORT_ISOLATION
endif
...
TC_CFLAGS+=-DTCSUPPORT_SNOOPING_SEPERATION
endif
...
TC_CFLAGS+=-DTCSUPPORT_MULIF_WAN_SAME_MAC
endif
...
TC_CFLAGS+=-DTCSUPPORT_XPON_HAL_API_NG
endif
...
TC_CFLAGS+=-DTCSUPPORT_QDMA_LAN_DSCP_NUM=1
export TCSUPPORT_QDMA_LAN_DSCP_NUM=1
endif
ifeq ($(strip $(TCSUPPORT_QDMA_LAN_DSCP_NUM)),2)
TC_CFLAGS+=-DTCSUPPORT_QDMA_LAN_DSCP_NUM=2
...
export DMS_CFLAGS=-DTCSUPPORT_DMS
endif
...
TC_CFLAGS+=-DTCSUPPORT_WLAN_MWDS
endif
...
TC_CFLAGS+=-DTCSUPPORT_CDS_PASSWD_ENCRYPT
endif
...
TC_CFLAGS+=-DTCSUPPORT_CT_WLAN_JOYME3
TC_CFLAGS+=-DTCSUPPORT_WLAN_ACL_BLK_COUNT
TC_CFLAGS+= -DTCSUPPORT_WLAN_MIXMODE
TC_CFLAGS+= -DTCSUPPORT_WLAN_VENDIE
TC_CFLAGS+= -DTCSUPPORT_WLAN_ACS
TC_CFLAGS+=-DTCSUPPORT_WLAN_DOT11K_RRM
TC_CFLAGS+= -DTCSUPPORT_WLAN_DOT11V_WNM
TC_CFLAGS+= -DTCSUPPORT_WLAN_BNDSTRG
TC_CFLAGS+= -DTCSUPPORT_WLAN_BNDSTRG_JOYME3
TC_CFLAGS+= -DTCSUPPORT_WLAN_WIFI_DIAG
endif
...
TC_CFLAGS+=-DTCSUPPORT_GOOGLE_FIBER_DHCPv6C
endif

ifneq ($(strip $(TCSUPPORT_GOOGLE_FIBER)),)
export TCSUPPORT_GOOGLE_FIBER=1
TC_CFLAGS+=-DTCSUPPORT_GOOGLE_FIBER
endif
...
TC_CFLAGS+=-DTCSUPPORT_SOFT_RATELIMIT
endif
...
TC_CFLAGS+=-DTCSUPPORT_MULTI_SWITCH_EXT
endif

ifneq ($(strip $(TCSUPPORT_MANUAL_ETHERNET_PORTMAP)),)
TC_CFLAGS+=-DTCSUPPORT_MANUAL_ETHERNET_PORTMAP
ifneq ($(strip $(TCSUPPORT_MULTI_SWITCH_EXT)),)
TC_CFLAGS+=-DTCSUPPORT_ETHERNET_PORTMAP=\""$(TCSUPPORT_WAN_PORT)_$(TCSUPPORT_LAN0_PORT)_$(TCSUPPORT_LAN1_PORT)_$(TCSUPPORT_LAN2_PORT)_$(TCSUPPORT_LAN3_PORT)_$(TCSUPPORT_LAN4_PORT)_$(TCSUPPORT_LAN5_PORT)_$(TCSUPPORT_LAN6_PORT)_$(TCSUPPORT_LAN7_PORT)_$(TCSUPPORT_LAN8_PORT)_$(TCSUPPORT_LAN9_PORT)_$(TCSUPPORT_LAN10_PORT)"\"
else
...
TC_CFLAGS+=-DTCSUPPORT_CT_PPP_MANUALLY
endif
...
TC_CFLAGS+=-DTCSUPPORT_VOIP_4FXS
endif
...
TC_CFLAGS+=-DTCSUPPORT_IS_FH_CO_GW
endif
...
TC_CFLAGS+=-DTCSUPPORT_XPON_HYBIRD
endif
...
TC_CFLAGS+=-DTCSUPPORT_CT_JOYME4
endif
...
TC_CFLAGS+=-DTCSUPPORT_CT_OPENJDK
endif
...
TC_CFLAGS+=-DTCSUPPORT_WLAN_PERSSID_SWITCH_ENHANCE
endif

ifneq ($(strip $(TCSUPPORT_CSC_EEUROPE)),)
export TCSUPPORT_CSC_EEUROPE=1
TC_CFLAGS+=-DTCSUPPORT_CSC_EEUROPE
endif
...
TC_CFLAGS+=-DTCSUPPORT_FH_UNIFIED_PLATFORM
endif
...
TC_CFLAGS+=-DTCSUPPORT_FH_SDN_PON
endif
...
TC_CFLAGS+=-DTCSUPPORT_TEST_SAMBA_SHORTCUT
endif
...
#BLAPI for ECNT APP
export BLLIB_PERFORM=-lblapi_perform 
export BLLIB_TRAFFIC=-lblapi_traffic 
export BLLIB_SYSTEM=-lblapi_system 
export BLLIB_WLAN=-lapi_lib_wifimgr 
export BLLIB_TC_PARTITION=-lblapi_tc_partition
export BLLIB_XDSL=-lblapi_xdsl
export BLLIB_PON=-lblapi_pon

KERNELHEAD_CFLAGS=-I$(INSTALL_KERNELHEADER)
export KERNELHEAD_CFLAGS


export APP_LINK=-Wl,-rpath-link,$(BSP_EXT_LIB):$(LIB_INSTALL_DIR)

LIBINSTALL_CFLAGS+=-I$(LIB_INSTALL_DIR) -I$(BSP_EXT_INC)
export LIBINSTALL_CFLAGS

LIBINSTALL_LDFLAGS+=-L$(LIB_INSTALL_DIR) -L$(BSP_EXT_LIB) $(APP_LINK)
export LIBINSTALL_LDFLAGS
