...
echo "../../../install_bsp/tools/trx/trx -d $size_f -f romfile_epon.cfg -o ctromfile_epon.cfg"
echo `../../../install_bsp/tools/trx/trx -d $size_f -f romfile_epon.cfg -o ctromfile_epon.cfg`
echo "cp ctromfile_epon.cfg $FS_GEN_DIR/userfs"
cp ctromfile_epon.cfg $FS_GEN_DIR/userfs
