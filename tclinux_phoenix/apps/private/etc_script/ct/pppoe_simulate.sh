...
if [ "$TCSUPPORT_CT_VPN_PPTP" != "" ] ;then
	PPP_PARAM="nodetach holdoff 4 maxfail $RetryTimes usepeerdns lcp-echo-interval 1 lcp-echo-failure 60 plugin /lib/libpppoe.so $NASName noipdefault persist mtu 1492 mru 1492"
else
