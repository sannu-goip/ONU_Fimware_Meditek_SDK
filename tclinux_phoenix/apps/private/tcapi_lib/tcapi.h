...
#define TCAPI_SHOW_ENHANCE_CMD			10
#define TCAPI_SAVE_RAW_CMD			11
...
#define TCAPI_TFTP_ROMFILE_FAIL 	-6
#define TCAPI_WRITE_ROMFILE_FAIL 	-7
#endif
#ifdef TCSUPPORT_INIC_CLIENT
#define TCAPI_CP_ROMFILE_FAIL 		-8
#endif
...
tcapi_msg{
	...
	*/
	...
	char path[MAXLEN_TCAPI_PATH_LEN];
	int type;
} tcapi_msg_t;
